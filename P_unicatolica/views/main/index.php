    ...
    <div class="container">
        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <h1 class="card-title pricing-card-title">11 <small class="text-muted">/ <i class="bi bi-house-fill"></i></small></h1>
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <h1 class="card-title pricing-card-title">122 <small class="text-muted">/ <i class="bi bi-laptop"></i></small></h1>
                    <ul class="list-unstyled mt-3 mb-4">
...
<div class="container">
  <div class="py-5 text-center">
    <img class="d-block mx-auto mb-4" src="public/img/logo.svg" alt="" width="200" height="200">
    <h2>Checkout form</h2>
